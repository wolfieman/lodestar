...
from ignite.retrieval.base import Snippet
from ignite.retrieval.embed import HashEmbedder
from ignite.retrieval.knowledge import VectorRetriever, format_snippets, load_snippets
